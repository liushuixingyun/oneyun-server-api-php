...
abstract class ConditionOptions
{
     ...
     */
    public static function create($where = null, $sort = null, $priority = 0, $queue_timeout = null, $fetch_timeout = null,$remark = null)
    {
        return new CreateConditionOptions($where, $sort, $priority, $queue_timeout = null, $fetch_timeout = null,$remark);
    }
}
...
{
    public function __construct($where = Values::NONE, $sort = Values::NONE, $priority = Values::NONE, $queue_timeout = Values::NONE,$fetch_timeout = Values::NONE,$remark = Values::NONE)
    {
