...
abstract class SmsOptions
{
    ...
    {
        return new CreateSmsOptions($destPhone, $tempId, $tempArgs);
    }

    public static function createMass($taskName = null, $tempId = null, $tempArgs = null, $mobiles = null, $sendTime = null)
    {
        return new CreateSmsMassOptions($taskName, $tempId, $tempArgs, $mobiles, $sendTime);
    }
}
...
class CreateSmsMassOptions extends Options
{
